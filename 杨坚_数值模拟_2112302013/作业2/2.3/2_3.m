...
filename = '2_3_涡旋.gif'; % 定义将要创建的动画文件的名称
...
while count<t
    ...
    % 考虑beta效应
    zeta2(jy,ix)=zeta2(jy,ix)+(zeta2(jy+1,ix)+zeta2(jy-1,ix)+zeta2(jy,ix+1)+zeta2(jy,ix-1))*Ah*r_dx2*dt-dt*beta*(psi(jy,ix+1)-psi(jy,ix-1))*0.5; 
    diffusion_periobc;
